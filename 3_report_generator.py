...
for policy in policies:
    ...
    value_dict_X[policy] = copy.deepcopy(X)
    value_dict_miss[policy] = copy.deepcopy(miss_Y)
    value_dict_AAT[policy] = copy.deepcopy(AAT_Y)
...
# Plot each curve
for policy in policies:
    plt.plot(value_dict_X[policy], value_dict_AAT[policy], label="policy = "+ get_policy(policy))
